...
(function(){
  ...
  function screenContext(){
    ...
    return Object.assign({},base,{
      ...
      result:state.result,
      battleContext:battleContext(base)
    });
  }
...
(function () {
  ...
  function showBattleToast() {
    const log = document.querySelector('#ddApp .battleLog');
    if (!log) return;
    log.classList.add('dd-toast-visible');
    if (toastTimer) clearTimeout(toastTimer);
    toastTimer = setTimeout(() => log.classList.remove('dd-toast-visible'), 1800);
  }
  ...
  function boot() {
    ...
    document.addEventListener('dd:battle-resolution-applied', showBattleToast);
    document.addEventListener('dd:battle-status-phase-ticked', showBattleToast);
  }
