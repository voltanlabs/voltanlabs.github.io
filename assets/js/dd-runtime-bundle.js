...
(function(){
  ...
  function installStyle(){
    ...
    style.textContent=[
      ...
      '@keyframes ddWormholeDepth{0%,100%{background-position:50% 76%,50% 76%,50% 76%;filter:brightness(1) drop-shadow(0 0 10px rgba(56,189,248,.82))}50%{background-position:50% 70%,50% 70%,50% 70%;filter:brightness(1.28) drop-shadow(0 0 16px rgba(56,189,248,1))}}',
