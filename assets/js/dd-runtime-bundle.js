...
(function(){
  ...
  function installStyle(){
    ...
    style.textContent=[
      ...
      '@media(max-width:430px){#ddApp .battle-card[data-owner="dd-battle-screen"] .battleGrid{grid-template-columns:minmax(0,1fr) 18px minmax(0,1fr);padding:44px 12px 12px}#ddApp .battle-card[data-owner="dd-battle-screen"] .vs{padding-bottom:76px}#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="lead"],#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"]{transform:none}#ddApp .battle-card[data-owner="dd-battle-screen"] .ring{width:min(32vw,132px);height:min(44vw,174px)}#ddApp .battle-card[data-owner="dd-battle-screen"] .dd-portal-canvas{top:-4px;bottom:-4px;left:-4px;width:74px;height:calc(100% + 8px)}#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .dd-portal-canvas{left:auto;right:-4px}#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::before{top:-6px;bottom:-6px;left:-6px;width:80px}#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::after{top:-4px;bottom:-4px;left:-4px;width:76px}#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .ring::before{left:auto;right:-6px}#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .ring::after{left:auto;right:-4px}#ddApp .battle-card[data-owner="dd-battle-screen"] .avatar img,#ddApp .battle-card[data-owner="dd-battle-screen"] .avatar .dd-sprite-sheet{width:112%;height:112%}#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="lead"] .avatar{translate:10px 0}#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .avatar{translate:-10px 0}#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter h2{font-size:clamp(19px,5vw,25px)}}',
