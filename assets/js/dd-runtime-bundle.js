...
(function(){
  ...
  function installStyle(){
    ...
    style.textContent=[
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::before{content:"";position:absolute;top:-6px;bottom:-6px;left:-10px;width:84px;border-radius:50% / 42%;border:3px solid color-mix(in srgb,var(--hp-color) 78%,#38BDF8);background:transparent;box-shadow:0 0 24px color-mix(in srgb,var(--hp-color) 28%,transparent);z-index:2;pointer-events:none}',
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .ring::before{left:auto;right:-10px}',
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="lead"] .avatar,#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .avatar{translate:0 0}',
