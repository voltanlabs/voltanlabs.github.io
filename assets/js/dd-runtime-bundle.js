...
(function(){
  ...
  function installStyle(){
    ...
    style.textContent=[
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .dd-portal-canvas{position:absolute;top:-5px;bottom:-5px;left:-5px;width:82px;height:calc(100% + 10px);border-radius:50% / 42%;background:radial-gradient(ellipse at 50% 76%,#010817,#07111f 68%,#020617);transform:scaleX(-1);z-index:0;pointer-events:none}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .dd-portal-canvas{left:auto;right:-5px}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::before{content:"";position:absolute;top:-6px;bottom:-6px;left:-6px;width:84px;border-radius:50% / 42%;border:3px solid color-mix(in srgb,var(--hp-color) 78%,#38BDF8);background:transparent;box-shadow:0 0 24px color-mix(in srgb,var(--hp-color) 28%,transparent);transform:scaleX(-1);z-index:2;pointer-events:none}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::after{content:"";position:absolute;top:-5px;bottom:-5px;left:-5px;width:82px;border-radius:50% / 42%;background:repeating-conic-gradient(from var(--dash-angle),color-mix(in srgb,var(--rarity-color) 92%,white) 0deg 3deg,transparent 3deg 17deg);-webkit-mask:radial-gradient(closest-side,transparent calc(100% - 4px),#000 calc(100% - 3px));mask:radial-gradient(closest-side,transparent calc(100% - 4px),#000 calc(100% - 3px));animation:ddPortalDashFlow 3.2s linear infinite;filter:drop-shadow(0 0 6px color-mix(in srgb,var(--rarity-color) 82%,transparent));transform:scaleX(-1);z-index:1}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .ring::before{left:auto;right:-6px}',
...
// assets/js/databyte-discovery-product-app-v4-shell.js
// Phase 6.3.4 application shell for Data Discovery.
