...
(function(){
  ...
  function installStyle(){
    ...
    style.textContent=[
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::before{content:"";position:absolute;top:4px;bottom:4px;left:-22px;width:64px;border:2px solid color-mix(in srgb,var(--hp-color) 72%,#38BDF8);border-radius:50% / 42%;background:radial-gradient(ellipse at 50% 52%,rgba(14,165,233,.3),rgba(7,17,31,.92) 62%,rgba(2,6,23,.98) 100%),repeating-linear-gradient(90deg,transparent 0 10px,rgba(125,211,252,.22) 11px 12px);box-shadow:0 0 24px color-mix(in srgb,var(--hp-color) 24%,transparent),inset 0 0 28px rgba(56,189,248,.24);animation:ddPortalSpin 9s linear infinite;filter:drop-shadow(0 0 8px rgba(56,189,248,.7));z-index:-1}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::after{content:"";position:absolute;top:17px;bottom:17px;left:-13px;width:46px;border:1px solid rgba(125,211,252,.42);border-radius:50% / 42%;box-shadow:inset 0 0 22px rgba(56,189,248,.22),0 0 18px rgba(56,189,248,.16);animation:ddPortalPulse 2.4s ease-in-out infinite;z-index:-1}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .ring::before{left:auto;right:-22px}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .ring::after{left:auto;right:-13px}',
