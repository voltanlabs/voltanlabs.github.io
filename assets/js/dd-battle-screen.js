...
(function(){
  ...
  function installStyle(){
    ...
    style.textContent=[
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::before{content:"";position:absolute;top:4px;bottom:4px;left:-22px;width:64px;border-radius:50% / 42%;border:2px solid color-mix(in srgb,var(--hp-color) 72%,#38BDF8);background:radial-gradient(ellipse at 50% 52%,rgba(14,165,233,.3),rgba(7,17,31,.92) 62%,rgba(2,6,23,.98) 100%),linear-gradient(rgba(125,211,252,.18) 1px,transparent 1px),linear-gradient(90deg,rgba(125,211,252,.2) 1px,transparent 1px);background-size:100% 100%,12px 12px,12px 12px;box-shadow:0 0 24px color-mix(in srgb,var(--hp-color) 24%,transparent),inset 0 0 28px rgba(56,189,248,.24);filter:drop-shadow(0 0 8px rgba(56,189,248,.7));z-index:-1}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::after{content:"";position:absolute;top:-5px;bottom:-5px;left:-27px;width:74px;border:2px dashed rgba(125,211,252,.78);border-radius:50% / 42%;box-shadow:0 0 14px rgba(56,189,248,.42);animation:ddPortalSpin 9s linear infinite;z-index:-1}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .ring::before{left:auto;right:-22px}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .ring::after{left:auto;right:-27px}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .avatar{position:relative;width:72%;height:100%;display:grid;place-items:center;background:transparent;font-size:clamp(28px,8vw,40px);line-height:1;z-index:1;overflow:visible}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="lead"] .avatar{translate:26px 0}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .avatar{translate:-26px 0}',
