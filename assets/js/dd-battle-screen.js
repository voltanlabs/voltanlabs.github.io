...
(function(){
  ...
  function installStyle(){
    ...
    style.id=STYLE_ID;
    style.textContent=[
      '#ddApp .battle-card[data-owner="dd-battle-screen"]{position:relative;display:grid;grid-template-rows:minmax(0,1fr) auto auto;gap:8px;min-height:0;overflow:hidden}',
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .signalBox,#ddApp .battle-card[data-owner="dd-battle-screen"] .downloadGauge{margin:0;padding:8px 10px;border:1px solid rgba(96,165,250,.25);border-radius:16px;background:rgba(15,23,42,.55)}',
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .signalBox div,#ddApp .battle-card[data-owner="dd-battle-screen"] .downloadGauge div{display:flex;align-items:center;justify-content:space-between;gap:8px}',
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .signalBox em,#ddApp .battle-card[data-owner="dd-battle-screen"] .downloadGauge em{display:block;margin-top:6px;height:8px;border-radius:999px;background:#020617;overflow:hidden}',
