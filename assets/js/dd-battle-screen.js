...
(function(){
  ...
  function installStyle(){
    ...
    style.textContent=[
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::before{content:"";position:absolute;top:4px;bottom:4px;left:-22px;width:64px;border-radius:50% / 42%;border:2px solid color-mix(in srgb,var(--hp-color) 72%,#38BDF8);background:radial-gradient(ellipse at 50% 54%,rgba(125,211,252,.62) 0 4%,rgba(14,165,233,.34) 18%,rgba(7,17,31,.9) 64%,rgba(2,6,23,.98) 100%),repeating-conic-gradient(from 0deg at 50% 54%,rgba(125,211,252,.48) 0deg 1deg,transparent 1deg 14deg),repeating-radial-gradient(ellipse at 50% 54%,transparent 0 12px,rgba(125,211,252,.34) 13px 14px);box-shadow:0 0 30px color-mix(in srgb,var(--hp-color) 36%,transparent),inset 0 0 34px rgba(56,189,248,.4);filter:drop-shadow(0 0 10px rgba(56,189,248,.82));z-index:-1}',
