...
(function(){
  ...
  function installStyle(){
    ...
    style.textContent=[
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::before{content:"";position:absolute;top:4px;bottom:4px;left:-22px;width:64px;border-radius:50% / 42%;border:2px solid color-mix(in srgb,var(--hp-color) 72%,#38BDF8);background:radial-gradient(ellipse at 50% 54%,#010817 0 10%,rgba(2,30,60,.96) 18%,rgba(14,165,233,.46) 28%,rgba(7,17,31,.9) 66%,rgba(2,6,23,.98) 100%),repeating-radial-gradient(ellipse at 50% 54%,transparent 0 7px,rgba(125,211,252,.4) 8px 9px,transparent 10px 15px),repeating-conic-gradient(from 0deg at 50% 54%,rgba(125,211,252,.52) 0deg 1deg,transparent 1deg 14deg);box-shadow:0 0 30px color-mix(in srgb,var(--hp-color) 36%,transparent),inset 0 0 34px rgba(56,189,248,.5);filter:drop-shadow(0 0 10px rgba(56,189,248,.82));z-index:-1}',
