...
(function(){
  ...
  function installStyle(){
    ...
    style.textContent=[
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .ring::before{content:"";position:absolute;top:1px;bottom:1px;left:-3px;width:78px;border-radius:50% / 42%;border:3px solid color-mix(in srgb,var(--hp-color) 78%,#38BDF8);background:transparent;box-shadow:0 0 24px color-mix(in srgb,var(--hp-color) 28%,transparent);z-index:2}',
      ...
      '#ddApp .battle-card[data-owner="dd-battle-screen"] .fighter[data-side="wild"] .ring::before{left:auto;right:-3px}',
