...
const BUNDLE = '/assets/js/dd-runtime-bundle.js?v=presentation-6-3-6';
...
const modules = Object.freeze([
  ...
  '/assets/js/dd-app-presentation-runtime.js?v=data-line-portals-6-3-0',
  '/assets/js/dd-scanner-screen.js?v=recovery-4-9-1',
  '/assets/js/dd-encounter-screen.js?v=discovery-reveal-1-3-0',
  '/assets/js/dd-battle-screen.js?v=data-line-portals-6-3-0',
  ...
  '/assets/js/databyte-discovery-product-app-v4-shell.js?v=presentation-shell-4-10-8'
]);
