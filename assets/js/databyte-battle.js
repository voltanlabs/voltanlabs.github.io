...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      .db-battle-stage-overlay{position:absolute;inset:0;z-index:15;border-radius:inherit;background:transparent;display:grid;grid-template-rows:auto 1fr auto auto auto;gap:9px;padding:18px;overflow:auto;overscroll-behavior:contain}.db-battle-stage-overlay.hidden{display:none!important}.db-battle-title{display:flex;align-items:center;justify-content:space-between;gap:10px;color:#fecaca;font-size:11px;text-transform:uppercase;letter-spacing:.18em}.db-battle-arena{display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:10px}.db-battle-fighter{display:grid;place-items:center;text-align:center;min-width:0}.db-battle-icon{width:clamp(120px,22vw,210px);height:clamp(120px,22vw,210px);border-radius:999px;border:1px solid rgba(0,123,255,.55);background:rgba(0,123,255,.18);display:grid;place-items:center;font-size:clamp(3.6rem,11vw,6.8rem);line-height:1;box-shadow:0 0 34px rgba(0,123,255,.28);margin-bottom:8px}.db-battle-name{color:#fff;font-weight:900;font-size:clamp(1.15rem,4vw,2rem);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:100%}.db-battle-type{color:#BAE6FD;font-size:11px;margin-top:2px}.db-battle-hp{margin-top:8px;color:#BAE6FD;font-size:11px}.db-battle-bar{height:8px;background:rgba(15,23,42,.72);border-radius:999px;overflow:hidden;margin-top:5px;width:100%;max-width:220px;border:1px solid rgba(125,211,252,.16)}.db-battle-fill{height:100%;width:var(--fill);background:linear-gradient(90deg,rgba(34,197,94,.9),rgba(250,204,21,.9));border-radius:inherit}.db-battle-vs{color:#FFD700;font-weight:900;letter-spacing:.18em;text-shadow:0 0 18px rgba(255,215,0,.35)}.db-battle-signal-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.db-battle-meter{background:rgba(15,23,42,.72);border:1px solid rgba(125,211,252,.18);border-radius:14px;padding:9px 10px}.db-battle-meter span{display:flex;justify-content:space-between;color:#BAE6FD;font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:.12em}.db-battle-meter strong{color:#FFD700}.db-battle-track{height:7px;background:rgba(255,255,255,.12);border-radius:999px;margin-top:7px;overflow:hidden}.db-battle-signal-fill{height:100%;width:var(--fill);background:linear-gradient(90deg,rgba(34,211,238,.9),rgba(255,215,0,.9));border-radius:inherit}.db-stability-pips{color:#FFD700;letter-spacing:.2em;font-size:13px}.db-battle-log{min-height:52px;max-height:76px;overflow:auto;border:1px solid rgba(125,211,252,.18);background:rgba(15,23,42,.72);border-radius:14px;padding:9px;color:#CBD5E1;font-size:12px}.db-battle-actions{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.db-battle-actions button{border-radius:15px;padding:12px 8px;font-size:12px;font-weight:900;border:1px solid rgba(255,255,255,.16);background:rgba(15,23,42,.72);color:#E5E7EB}.db-battle-actions button[data-battle-action=attack]{border-color:rgba(252,165,165,.48);color:#fecaca;background:rgba(239,68,68,.12)}.db-battle-actions button[data-battle-action=pulse]{border-color:rgba(255,215,0,.45);color:#FFD700}.db-battle-actions button[data-battle-action=capture]{background:#FFD700;color:#111827;border-color:#FFD700}@media(max-width:768px){.db-battle-stage-overlay{padding:14px}.db-battle-arena{grid-template-columns:1fr;gap:7px}.db-battle-vs{display:none}.db-battle-actions{grid-template-columns:repeat(2,minmax(0,1fr))}.db-battle-signal-grid{grid-template-columns:1fr}.db-battle-log{max-height:64px}.db-battle-icon{width:104px;height:104px;font-size:3.8rem}}
    `;
  ...
  function renderStage() {
    ...
    const canAct = !battle.finished;
    overlay.innerHTML = `<div class="db-battle-title"><span>Signal Battle</span><span>${battle.lost ? "Signal Lost" : battle.finished ? "Resolved" : "Active"}</span></div><div class="db-battle-arena">${fighter(battle.player, battle.playerHp, "Party Lead")}<div class="db-battle-vs">VS</div>${fighter(battle.enemy, battle.enemyHp, "Wild Signal")}</div>${meters()}<div class="db-battle-log">${battle.log.slice(0, 6).map((line) => `<p>${line}</p>`).join("")}</div><div class="db-battle-actions"><button type="button" data-battle-action="attack" ${canAct ? "" : "disabled"}>Attack</button><button type="button" data-battle-action="guard" ${canAct ? "" : "disabled"}>Guard</button><button type="button" data-battle-action="pulse" ${canAct ? "" : "disabled"}>Scan Pulse</button><button type="button" data-battle-action="capture" ${battle.lost ? "disabled" : ""}>Throw ByteCoin</button></div>`;
