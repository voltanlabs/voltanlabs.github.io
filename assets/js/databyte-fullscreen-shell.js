...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      body.dd-fullscreen-mode .dd-app-dock{display:grid!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;gap:7px!important;padding:7px!important;height:64px!important;min-height:64px!important;border:1px solid rgba(125,211,252,.18)!important;border-radius:18px!important;background:rgba(15,23,42,.86)!important;box-sizing:border-box!important}
      body.dd-fullscreen-mode .dd-app-dock button{min-height:42px!important;border:1px solid rgba(125,211,252,.24)!important;background:rgba(30,41,59,.72)!important;color:#E5E7EB!important;border-radius:13px!important;padding:7px 4px!important;font-weight:800!important;font-size:.6rem!important;line-height:1.05!important}.dd-app-dock button strong{display:block!important;color:#FFD700!important;font-size:.8rem!important;margin-bottom:1px!important}
      ...
      body.dd-fullscreen-mode #gamePanel .scan-bg + div,body.dd-fullscreen-mode #gamePanel .scan-bg~div{position:relative!important;z-index:5!important;min-height:0!important;max-height:36dvh!important;overflow:auto!important;overscroll-behavior:contain!important;padding:10px!important;background:rgba(7,17,31,.78)!important;border:1px solid rgba(125,211,252,.16)!important;border-radius:18px!important;margin:0!important;box-sizing:border-box!important}
      body.dd-fullscreen-mode #encounterCard{max-height:52dvh!important;overflow:auto!important;overscroll-behavior:contain!important;margin-top:10px!important}
      body.dd-fullscreen-mode #databyteSignalOverlay,body.dd-fullscreen-mode #dbBattlePhase2{inset:0!important;height:100%!important;max-height:100%!important;overflow:auto!important;overscroll-behavior:contain!important;padding-bottom:10px!important;box-sizing:border-box!important}
      ...
      @media(orientation:landscape) and (min-width:820px){body.dd-fullscreen-mode .dd-app-shell{grid-template-rows:minmax(0,1fr)!important}body.dd-fullscreen-mode .dd-app-main{grid-template-columns:minmax(520px,1.25fr) minmax(300px,.75fr)!important;gap:10px!important}body.dd-fullscreen-mode .dd-app-side{display:grid!important;min-height:0!important;overflow:auto!important}body.dd-fullscreen-mode .dd-app-dock{display:none!important}body.dd-fullscreen-mode #gamePanel>div>div:nth-child(2){grid-template-columns:minmax(0,1fr) 330px!important;grid-template-rows:minmax(0,1fr)!important}body.dd-fullscreen-mode #gamePanel .scan-bg + div,body.dd-fullscreen-mode #gamePanel .scan-bg~div{max-height:100%!important}}
    `;
