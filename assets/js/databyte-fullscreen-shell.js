...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      body.dd-fullscreen-mode .dd-app-stage{min-height:0!important;overflow:auto!important;overscroll-behavior:contain!important;display:block!important;border:1px solid rgba(0,123,255,.20)!important;border-radius:22px!important;background:rgba(7,17,31,.26)!important}
      ...
      body.dd-fullscreen-mode #gamePanel{display:grid!important;grid-template-columns:1fr!important;width:100%!important;max-width:760px!important;margin:0 auto!important;padding:0!important;border-radius:22px!important;overflow:visible!important;box-sizing:border-box!important;background:transparent!important}
      ...
      body.dd-fullscreen-mode #gamePanel .scan-bg{min-height:calc(100dvh - 94px)!important;height:calc(100dvh - 94px)!important;border:0!important;border-radius:22px!important;background-color:transparent!important;background-image:none!important;overflow:hidden!important}
      ...
      .dd-start-screen{position:absolute;inset:0;z-index:1000000;display:grid;place-items:center;padding:24px;box-sizing:border-box;text-align:center;background:rgba(7,17,31,.30)}.dd-start-card{width:min(100%,620px);display:grid;gap:18px;padding:28px 20px;border:1px solid rgba(125,211,252,.24);border-radius:28px;background:rgba(15,23,42,.72);box-shadow:0 24px 80px rgba(0,0,0,.38);backdrop-filter:blur(8px)}.dd-start-kicker{color:#FFD700;font-weight:900;letter-spacing:.24em;text-transform:uppercase;font-size:.72rem}.dd-start-title{color:#0787ff;font-size:clamp(2.2rem,12vw,5rem);font-weight:900;line-height:.92}.dd-start-copy{color:#CBD5E1;font-size:1rem;line-height:1.45}.dd-start-btn{border:0;border-radius:18px;background:#FFD700;color:#111827;font-weight:900;padding:15px 18px;font-size:1rem}.dd-start-note{color:#BAE6FD;font-size:.75rem;letter-spacing:.08em;text-transform:uppercase}
