...
(function(){
  ...
  function add(){
    ...
    load('ddWheelNavLoader','/assets/js/dd-wheel-nav.js?v=0902');
    load('ddScreenTuneLoader','/assets/js/dd-screen-tune.js?v=0902');
    load('ddReturnFixLoader','/assets/js/dd-return-fix.js?v=0902');
  }
