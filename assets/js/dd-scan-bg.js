...
(function(){
  ...
  function add(){
    if(!document.getElementById('ddScanBgStyle')){
    ...
    load('ddWheelNavLoader','/assets/js/dd-wheel-nav.js?v=0903');
    load('ddScreenTuneLoader','/assets/js/dd-screen-tune.js?v=0903');
    load('ddReturnFixLoader','/assets/js/dd-return-fix.js?v=0903');
    load('ddScannerOsPolishLoader','/assets/js/dd-scanner-os-polish.js?v=0903');
  }
