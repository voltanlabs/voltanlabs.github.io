...
load('ddWheelNavLoader','/assets/js/dd-wheel-nav.js?v=0907');
load('ddScreenTuneLoader','/assets/js/dd-screen-tune.js?v=0907');
load('ddReturnFixLoader','/assets/js/dd-return-fix.js?v=0907');
load('ddScannerOsPolishLoader','/assets/js/dd-scanner-os-polish.js?v=0907');
load('ddNavCleanupLoader','/assets/js/dd-nav-cleanup.js?v=0907');
load('ddLivingScannerLoader','/assets/js/dd-living-scanner.js?v=0907');
load('ddRarityFxLoader','/assets/js/dd-rarity-fx.js?v=0907');
load('ddCaptureThemesLoader','/assets/js/dd-capture-themes.js?v=0907');
}
