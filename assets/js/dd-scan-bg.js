...
load('ddWheelNavLoader','/assets/js/dd-wheel-nav.js?v=0908');
load('ddScreenTuneLoader','/assets/js/dd-screen-tune.js?v=0908');
load('ddReturnFixLoader','/assets/js/dd-return-fix.js?v=0908');
load('ddScannerOsPolishLoader','/assets/js/dd-scanner-os-polish.js?v=0908');
load('ddNavCleanupLoader','/assets/js/dd-nav-cleanup.js?v=0908');
load('ddLivingScannerLoader','/assets/js/dd-living-scanner.js?v=0908');
load('ddRarityFxLoader','/assets/js/dd-rarity-fx.js?v=0908');
load('ddCaptureThemesLoader','/assets/js/dd-capture-themes.js?v=0908');
load('ddPortraitCardsLoader','/assets/js/dd-portrait-cards.js?v=0908');
}
