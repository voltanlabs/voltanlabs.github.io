...
(function () {
  ...
  installStyle();
  window.DD_BATTLE_PRESENTATION_RUNTIME = { version: '0.2.1', phase: '4.0-battle-presentation-runtime', emit, hit, heal, boost, warn, success, download, signal, reset, getHistory };
