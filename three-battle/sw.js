...
const CORE = [
  ...
  './main.js?v=dex-clean-1', './pwa.js?v=release-d4f04cc', './vendor/three.module.js', './vendor/three.core.js', './data/runtime-data.js', './data/species.json', './data/moves.json', './session.js?v=save-portability-1', './save-tools.js?v=save-portability-1',
  ...
  './data/sprites/placeholder.png', './data/sprites/leovolt.png', './data/sprites/scorpyone.png'
];
