...
const CORE = [
  './storage-sync.js?v=party-xp-merge-2', './enemy-ai.js?v=enemy-ai-2',
  './main.js?v=capture-xp-1',
 './', './index.html', './styles.css', './manifest.json', './move-catalog.js?v=move-catalog-60-1', './move-effects.js?v=move-effects-3', './reward-flow.js?v=reward-flow-1',
