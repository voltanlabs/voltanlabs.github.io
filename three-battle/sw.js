...
const CORE = [
  ...
  './main.js?v=fainted-result-1',
 './', './index.html', './styles.css', './manifest.json', './move-catalog.js?v=move-catalog-60-1', './move-effects.js?v=move-effects-4', './reward-flow.js?v=reward-flow-1',
