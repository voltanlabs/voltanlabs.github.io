...
const CORE = [
  ...
  './move-catalog.js?v=move-catalog-60-1', './move-effects.js?v=move-effects-5', './enemy-ai.js?v=enemy-ai-2', './battle-guards.js?v=fainted-capture-1',
  ...
  './missions.js?v=profile-missions-1', './recovery.js?v=hp-recovery-2', './encounter.js?v=rarity-window-1', './dex-ui.js?v=collection-count-1', './dex-details.js?v=dex-records', './regions.js?v=profile-regions-2', './region-encounters.js?v=profile-regional-pools-2', './events.js?v=profile-events-1', './reward-history.js?v=scaled-enemy-xp-1', './world-map.js?v=profile-world-map-2', './discovery-codes.js?v=profile-discovery-codes-1', './starter.js?v=paint-gate', './slots-ui.js?v=sprite-progression-1', './switch-ui.js', './os-nav.js?v=items-popup', './save-tools.js?v=save-safety-1', './pwa.js?v=release-0.1.4', './main.js?v=fainted-status-1'
];
