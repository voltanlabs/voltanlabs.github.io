const CACHE = 'databyte-three-release-76';
const CORE = [
  ...
  './reward-flow.js?v=reward-flow-1', './roster-loader.js?v=roster-v3', './session.js?v=profile-session-1', './species-progression.js?v=wild-form-gates-1', './instance-storage.js?v=stage-hp-rolls-1', './evolution-gate.js?v=instance-evolution-3', './storage-sync.js?v=party-xp-merge-2', './profile-normalizer.js?v=profile-normalizer-1',
