const CACHE = 'databyte-three-release-52';
const CORE = [
  './party-handoff.js?v=preserve-hp-handoff-1',
  './starter.js?v=starter-preview-1',
  './', './index.html', './styles.css', './scanner-effect.js?v=particle-portal-6', './status-tooltips.css?v=status-tooltips-1', './manifest.json',
