...
const CORE = [
  ...
  './main.js?v=dex-clean-1', './pwa.js?v=release-d4f04cc', './vendor/three.module.js', './vendor/three.core.js', './data/runtime-data.js', './data/species.json', './data/moves.json', './session.js?v=dex-clean-1',
