...
const CORE = [
 ...
 './main.js?v=release-features-1', './pwa.js?v=release-d4f04cc', './vendor/three.module.js', './vendor/three.core.js', './data/runtime-data.js', './data/species.json', './data/moves.json', './session.js?v=save-safety-1', './save-tools.js?v=save-safety-1',
  ...
  './data/sprites/placeholder.png', './data/sprites/leovolt.png', './data/sprites/scorpyone.png', './feedback.js?v=feedback-1', './capture-control.js?v=live-capture-1'
];
