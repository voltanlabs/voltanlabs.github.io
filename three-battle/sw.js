const CACHE = 'databyte-three-release-3';
const CORE = [
  './', './index.html', './styles.css', './manifest.json',
 './main.js?v=no-coins-capture-1', './pwa.js?v=release-d4f04cc', './vendor/three.module.js', './vendor/three.core.js', './data/runtime-data.js', './data/species.json', './data/moves.json', './session.js?v=capture-slots-5', './save-tools.js?v=save-safety-1',
