const CACHE = 'databyte-three-release-42';
const CORE = [
  ...
  './progression.js?v=profile-progression-1', './inventory.js?v=profile-inventory-2', './capture-pressure.js?v=pressure-loop-3', './environment.js?v=signal-environments', './combat-effects.js?v=combat-motion-3', './move-info.js?v=long-press-info-2',
