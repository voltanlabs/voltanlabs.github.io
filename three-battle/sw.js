const CACHE = 'databyte-three-release-53';
const CORE = [
  './party-handoff.js?v=preserve-hp-handoff-1',
  './starter.js?v=starter-preview-1',
  './', './index.html', './styles.css', './scanner-effect.js?v=particle-portal-7', './status-tooltips.css?v=status-tooltips-1', './manifest.json',
