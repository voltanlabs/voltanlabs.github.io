const CACHE = 'databyte-three-release-44';
const CORE = [
  ...
  './status-effects.js?v=status-runtime-2', './authored-moves.js?v=authored-family-moves-1', './move-catalog.js?v=move-catalog-62', './move-effects.js?v=move-effects-8', './battle-ai.js', './battle-guards.js?v=fainted-capture-1',
  ...
  './progression.js?v=profile-progression-1', './inventory.js?v=profile-inventory-2', './capture-pressure.js?v=pressure-loop-3', './environment.js?v=signal-environments', './combat-effects.js?v=combat-motion-3', './move-info.js?v=long-press-info-3',
