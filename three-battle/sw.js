const CACHE = 'databyte-three-release-70';
const CORE = [
  ...
  './missions.js?v=profile-missions-1', './recovery.js?v=signal-reboot-2', './encounter.js?v=discovery-sprite-path-1', './dex-ui.js?v=collection-count-1', './dex-details.js?v=dex-records', './regions.js?v=profile-regions-2', './region-encounters.js?v=region-level-bands-1', './events.js?v=profile-events-1', './reward-history.js?v=reward-xp-stages-1', './world-map.js?v=profile-world-map-2', './discovery-codes.js?v=profile-discovery-codes-1', './starter.js?v=paint-gate', './slots-ui.js?v=instance-deploy-3', './switch-ui.js?v=switch-instance-4', './os-nav.js?v=items-popup', './save-tools.js?v=save-safety-1', './pwa.js?v=release-0.1.5', './main.js?v=battle-flow-3'
];
