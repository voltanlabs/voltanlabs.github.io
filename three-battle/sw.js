const CACHE = 'databyte-three-release-75';
const CORE = [
  ...
  './reward-flow.js?v=reward-flow-1', './roster-loader.js?v=roster-v3', './session.js?v=profile-session-1', './species-progression.js?v=wild-form-gates-1', './instance-storage.js?v=hp-soft-targets-1', './evolution-gate.js?v=instance-evolution-3', './storage-sync.js?v=party-xp-merge-2', './profile-normalizer.js?v=profile-normalizer-1',
  ...
  './missions.js?v=profile-missions-1', './recovery.js?v=signal-reboot-2', './encounter.js?v=discovery-sprite-path-1', './dex-ui.js?v=collection-count-1', './dex-details.js?v=dex-records', './regions.js?v=region-level-gates-1', './region-encounters.js?v=region-level-bands-1', './events.js?v=profile-events-1', './reward-history.js?v=reward-xp-stages-1', './world-map.js?v=region-level-gates-1', './discovery-codes.js?v=profile-discovery-codes-1', './starter.js?v=paint-gate', './slots-ui.js?v=instance-deploy-3', './switch-ui.js?v=switch-instance-4', './os-nav.js?v=items-popup', './save-tools.js?v=save-safety-1', './pwa.js?v=release-0.1.10', './main.js?v=region-scan-handoff-1'
];
